...
public class zooIndex implements Serializable{
	 ...
	 * @throws IOException
	 */
	public zooIndex(String dbIndexPath, 
	 ...
	 * @throws IOException
	 */
	public void storeBucket(zooBucket buck)
		throws IOException{
		buck.storeZooData();
	}
	 ...
	 * @throws IOException
	 */
	public zooBucket loadBucket(int indexPos)
		throws IOException{

		long bucketAddr=bucketAddrs[indexPos];

		zooBucket buck = new zooBucket(this,maxBucketKeys,bucketAddr,indexPos); 
...
public boolean collapse(){
	...
	public void saveZooIndex() {
		zooKeeper zk = new zooKeeper();

		System.out.println("Save: " + this.toString());

		zk.setData("/zookeeper/index--" + this.bucketAddrs, this);
		try {
			zk.zooKeeper.close();
	...
	public void loadZooIndex(){
		zooKeeper zk = new zooKeeper();
		zooIndex loadIndex= 
				(zooIndex) zk.getData("/zookeeper/index--" + this.bucketAddrs);
